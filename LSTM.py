def RUN(block):	
	...
	actuals_path=f'./results/actuals_{block}_days_LSTM.txt'
	predicteds_path=f'./results/predicteds_{block}_days_LSTM.txt'
	metrics_path=f'./results/metrics_{block}_days_LSTM.txt'
	...
	plt.figure(f'Forecasting {block} days_plot_LSTM',dpi=200)
	...
	plt.figure(f'Forecasting {block} days_scatter_LSTM',dpi=200)
